      ...
      <div className={styles.content}>
        <div className={styles.titleContainer}>
          ...
          <p className={styles.subtitle}>
            Have questions about out premium fleet ? Out team is ready to assist
          ...
          <div className={styles.formCard}>
            ...
            <form onSubmit={handleSubmit} className={styles.form}>
              ...
              <div className="relative">
                ...
                onChange={handleChange}
                onFocus={() => handleFocus('message')} onBlur={handleBlur} required rows = '3' placeholder = 'Tell us about your rental needs...' className={styles.textarea(activeField === 'message')}
                ></textarea>
              </div>
